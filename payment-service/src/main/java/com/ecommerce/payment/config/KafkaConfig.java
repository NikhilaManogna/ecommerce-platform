...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderCreatedEvent> orderConsumerFactory(
        ...
        deserializer.addTrustedPackages("com.ecommerce.payment.event");
    ...
    @Bean
    public ProducerFactory<String, PaymentCompletedEvent> producerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrapServers) {
        Map<String, Object> props = new HashMap<>();
